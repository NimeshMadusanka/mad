...
import static com.example.mad_bestplace.User_Feed.USER;
...
public class Shop_Profile extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viwe.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Shop_Profile.this,food_feed.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_shopfeed){
            ...
            Intent intent = new Intent(Shop_Profile.this,User_Feed.class);

            intent.putExtra("user",USER);
            startActivity(intent);

        } else if (id == R.id.nav_addshop) {
            Intent intent = new Intent(Shop_Profile.this,Add_Shop.class);
            startActivity(intent);
